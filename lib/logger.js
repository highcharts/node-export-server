...
import { createDir, getAbsolutePath, getNewDate } from './utils.js';
...
export function enableFileLogging(dest, file, toFile) {
  ...
  if (logging.toFile) {
    logging.dest = getAbsolutePath(dest || logging.dest);
    logging.file = file || logging.file;
  }
}
