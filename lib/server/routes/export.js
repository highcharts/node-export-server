...
const exportHandler = (request, response) => {
  ...
  if (defaultOptions.export.height) {
    defaultOptions.export.defaultHeight = defaultOptions.export.height;
    defaultOptions.export.height = false;
  }

  // Save the width from default options
  if (defaultOptions.export.width) {
    defaultOptions.export.defaultWidth = defaultOptions.export.width;
    defaultOptions.export.width = false;
  }
  ...
  // Process resources (allowFileResources is set to false in case of requests)
