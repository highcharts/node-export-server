...
export const Config = z.object({
  ...
  HIGHCHARTS_CORE_SCRIPTS: v.array(defaultConfig.highcharts.coreScripts),
  HIGHCHARTS_MODULE_SCRIPTS: v.array(defaultConfig.highcharts.moduleScripts),
  HIGHCHARTS_INDICATOR_SCRIPTS: v.array(
    defaultConfig.highcharts.indicatorScripts
  ),
  HIGHCHARTS_CUSTOM_SCRIPTS: v.array(defaultConfig.highcharts.customScripts),
