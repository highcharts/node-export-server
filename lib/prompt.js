 ...
 *
 * @param {string} fileName - The name of the configuration file to save to.
        ...
        if (++questionsCounter === allQuestions.length) {
          try {
            ...
            logWithStack(
              1,
              error,
              `[prompt] An error occurred while creating the ${fileName} file.`
            );
          }
          return true;
        }
