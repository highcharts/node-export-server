 ...
 * directory, which serves as a dedicated folder for keeping cached files.
 */
...
export function getCachePath() {
  ...
  return isAbsolute(cachePathOption) // #562
    ? cachePathOption
 ...
 * @param {Object} [fetchedModules={}] - An object that contains mapped names
 * of fetched Highcharts modules to use.
 *
 ...
 * (full URLs).
 * @param {Object} proxyOptions - Options for the proxy agent to use
 * for a request.
 * @param {Object} fetchedModules - An object which tracks which Highcharts
 * modules have been fetched.
 *
