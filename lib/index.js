...
import { getGeneralOptions, setGeneralOptions } from './config.js';
import {
  initLogging,
  log,
  logWithStack,
 ...
 * will be retrieved using the `getGeneralOptions` function.
 *
 * @param {Object} [options=getGeneralOptions()] - Object that contains all
 * options.
 */
export async function initExport(options = getGeneralOptions()) {
