...
import { get, close, newPage as browserNewPage, create as createBrowser } from './browser.js';
...
const factory = {
  ...
  create: async () => {
    ...
    try {
      ...
      // TODO: This should be removed. we only need the page.
      browserInstance = await get();
...
export const init = async (config) => {
  ...
  // Wait until we've sucessfully created a browser.
  try {
