...
// Factory object with create, validate and destroy functions for the pool
const factory = {
  /**
   ...
   *
   * @returns {boolean} Returns true if the worker is valid and within the work
...
export async function initPool(
  poolOptions = getGeneralOptions().pool,
  puppeteerArgs
) {
  ...
  if (poolConfig.minWorkers > poolConfig.maxWorkers) {
  ...
  try {
    ...
    pool.on('destroySuccess', (_, resource) => {
