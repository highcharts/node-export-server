...
module.exports = {
  /**
   * Creates and gets a Puppeteer instance.
   *
   * @param {string} id - A common uuid to distinguish the user's instance
   * resource.
   * @param {object} puppeteerArgs - The options object for the Puppeteer
   * instance.
   */
