  ...
  server: {
    ...
    basicAuth: {
      enable: {
        value: false,
        type: 'boolean',
        envLink: 'SERVER_BASIC_AUTH_ENABLE',
        description: 'Enables basic authentication for the server.'
      },
      login: {
        value: 'login',
        type: 'string',
        envLink: 'SERVER_BASIC_AUTH_LOGIN',
        description: 'The login for basic authentication.'
      },
      password: {
        value: 'password',
        type: 'string',
        envLink: 'SERVER_BASIC_AUTH_PASSWORD',
...
export const promptsConfig = {
  ...
  server: [
    ...
    {
      type: 'text',
      name: 'basicAuth.enable',
      message: 'Enable basic authentication',
      initial: defaultConfig.server.basicAuth.enable.value
    },
    {
      type: 'text',
      name: 'basicAuth.login',
      message: 'Login for basic authentication',
      initial: defaultConfig.server.basicAuth.login.value
    },
    {
      type: 'text',
      name: 'basicAuth.password',
      message: 'Password for basic authentication',
      initial: defaultConfig.server.basicAuth.password.value
    }
  ],
  pool: [
    {
