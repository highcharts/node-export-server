...
export const defaultConfig = {
  ...
  server: {
    ...
    ssl: {
      enable: {
        ...
        type: 'boolean',
        cliName: 'enableSsl',
        description: 'If set to true, enables the SSL protocol.'
      },
      force: {
    ...
    rateLimiting: {
      ...
      skipToken: {
        envLink: 'RATE_LIMITING_SKIP_TOKEN',
        value: '',
        type: 'number|string',
        description:
  ...
  pool: {
    ...
    workLimit: {
      ...
      type: 'number',
      description:
        'The number of work pieces that can be performed before restarting the process.'
    },
    acquireTimeout: {
