 ...
 * arguments, and interactive prompts for customization and adaptability.
 ...
 * (`nestedArgs`). The new format is used for Puppeteer, while the old format
 * was used for PhantomJS.
 *
 * @function mapToNewConfig
 *
 ...
 * to the mapping defined in `nestedArgs`.
 */
 ...
 *
 * @function _createNestedArgs
 *
 * @param {Object} config - The nested configuration object containing argument.
 * @param {Object} [nestedArgs={}] - The accumulator object for storing
 * the resulting argument chains.
