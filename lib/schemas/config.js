...
const defaultConfig = {
  ...
  export: {
    ...
    type: {
      ...
      type: 'string',
      description:
        'The format of a file to export to. Can be jpg, jpeg, png, pdf or svg.'
    },
    constr: {
    ...
    globalOptions: {
      ...
      type: 'string',
      description:
        'A JSON string or a name of a file with options to be passed into the Highcharts.setOptions.'
    },
    batch: {
      value: false,
      type: 'string',
  ...
  pool: {
    initialWorkers: {
      value: +process.env.HIGHCHARTS_POOL_MIN_WORKERS || 8,
      type: 'number',
  ...
  other: {
    ...
    tempDir: {
      value: process.env.HIGHCHARTS_TEMP_DIR || 'temp/',
      type: 'string',
...
const promptsConfig = {
  ...
  other: [
    ...
    },
    {
      ...
      initial: defaultConfig.other.tempDir.value
    }
  ]
};
