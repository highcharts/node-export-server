...
export const defaultConfig = {
  ...
  highcharts: {
    ...
    cachePath: {
      ...
      description:
        'A directory path where the fetched Highcharts scripts should be placed.'
    },
    coreScripts: {
  ...
  server: {
    ...
    proxy: {
      ...
      timeout: {
        ...
        description:
          'The timeout, in milliseconds, for the proxy server to use, if it exists.'
      }
    },
    rateLimiting: {
      enable: {
  ...
  webSocket: {
    ...
    gatherAllOptions: {
      ...
      description:
        "Decides whether or not to gather all chart's options or only ones defined in the telemetry.json file."
    },
    url: {
      value: null,
      type: ['string', 'null'],
...
export const promptsConfig = {
  ...
  webSocket: [
    ...
    {
      type: 'toggle',
      name: 'gatherAllOptions',
      message: 'Decides whether or not to gather all chart options',
      initial: defaultConfig.webSocket.gatherAllOptions.value
    },
    {
      type: 'text',
      name: 'url',
