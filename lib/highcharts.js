 ...
 * export-specific configurations. Supports dynamic option merging, custom logic
 * injection, and control over rendering behaviors. Designed to accommodate
 * export workflows and custom user requirements. Used by the Puppeteer page.
 */
 ...
 * @param {Object} options - The general export server options.
