 ...
 * manages resources, sets up the export environment, and processes chart
 ...
 * @param {unknown} chart - The chart object or SVG configuration
 * to be exported.
 * @param {Object} options - Export options and configuration.
 *
 * @returns {Promise<(string|Buffer|ExportError)>} Promise resolving
