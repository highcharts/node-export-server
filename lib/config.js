...
const config = {
  ...
  server: {
    ...
    port: process.env.HIGHCHARTS_SERVER_PORT || 8080,
  ...
  pool: {
    ...
    maxWorkers: process.env.HIGHCHARTS_POOL_MAX_WORKERS || 4,
    // How many workers should initially be available?
    initialWorkers: process.env.HIGHCHARTS_POOL_MIN_WORKERS || 4,
