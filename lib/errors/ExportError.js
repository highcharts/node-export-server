...
/**
 * @overview A custom error class for handling export-related errors.
 */

/**
 * Extends the native `Error` class to include additional properties like status
 * code and stack trace details.
 */
