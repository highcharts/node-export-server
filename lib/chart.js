...
/**
 * Initiates the exporting process based on the provided settings and invokes
 * the endCallback upon error.
 *
 ...
 * error occurance of the exporting process.
 *
...
/**
 * Initiates a batch export process based on the specified options.
 *
...
/**
 * Initiates a single export process based on the specified options.
 *
 * @param {object} options - The options object containing configuration for
 * a single export.
 *
...
export const singleExport = async (options) => {
  ...
  // Perform an export
  await startExport(options, async (info, error) => {
